...
#include "mySprayParcel.H"
#include "IOstreams.H"

// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //

template<class ParcelType>
Foam::string Foam::mySprayParcel<ParcelType>::propertyList_ =
    Foam::mySprayParcel<ParcelType>::propertyList();


template<class ParcelType>
const std::size_t Foam::mySprayParcel<ParcelType>::sizeofFields
(
    sizeof(mySprayParcel<ParcelType>) - sizeof(ParcelType)
);
...
template<class ParcelType>
Foam::mySprayParcel<ParcelType>::mySprayParcel
(
    const polyMesh& mesh,
    Istream& is,
    bool readFields,
...
void Foam::mySprayParcel<ParcelType>::readFields(CloudType& c)
{
...
void Foam::mySprayParcel<ParcelType>::readFields
(
    CloudType& c,
...
)
{
    ...
    label i = 0;
    for (mySprayParcel<ParcelType>& p : c)
    {
        p.d0_ = d0[i];
...
template<class ParcelType>
template<class CloudType>
void Foam::mySprayParcel<ParcelType>::writeFields(const CloudType& c)
{
...
template<class ParcelType>
template<class CloudType, class CompositionType>
void Foam::mySprayParcel<ParcelType>::writeFields
(
    const CloudType& c,
    const CompositionType& compModel
)
{
    ...
    label i = 0;
    for (const mySprayParcel<ParcelType>& p : c)
    {
        d0[i] = p.d0_;
...
template<class ParcelType>
void Foam::mySprayParcel<ParcelType>::writeProperties
(
    Ostream& os,
...
template<class ParcelType>
template<class CloudType>
void Foam::mySprayParcel<ParcelType>::readObjects
(
    CloudType& c,
...
template<class ParcelType>
template<class CloudType>
void Foam::mySprayParcel<ParcelType>::writeObjects
(
    const CloudType& c,
    objectRegistry& obr
)
...
(
    Ostream& os,
    const mySprayParcel<ParcelType>& p
)
{
    ...
    else
    {
        ...
        (
            ...
            mySprayParcel<ParcelType>::sizeofFields
        );
    }
