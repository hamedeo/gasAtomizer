...
void Foam::mySprayParcel<ParcelType>::setCellValues
(
...
template<class ParcelType>
template<class TrackCloudType>
void Foam::mySprayParcel<ParcelType>::cellValueSourceCorrection
(
    TrackCloudType& cloud,
    trackingData& td,
    const scalar dt
...
template<class ParcelType>
template<class TrackCloudType>
void Foam::mySprayParcel<ParcelType>::calc
(
    TrackCloudType& cloud,
    trackingData& td,
    const scalar dt
...
template<class ParcelType>
template<class TrackCloudType>
void Foam::mySprayParcel<ParcelType>::calcAtomization
(
    TrackCloudType& cloud,
    trackingData& td,
    const scalar dt
...
template<class ParcelType>
template<class TrackCloudType>
void Foam::mySprayParcel<ParcelType>::calcBreakup
(
    TrackCloudType& cloud,
    trackingData& td,
    const scalar dt
)
{
    ...
    )
    {
        ...
        mySprayParcel<ParcelType>* child = new mySprayParcel<ParcelType>(*this);
...
template<class ParcelType>
template<class TrackCloudType>
Foam::scalar Foam::mySprayParcel<ParcelType>::chi
(
    TrackCloudType& cloud,
    trackingData& td,
    const scalarField& X
...
template<class ParcelType>
template<class TrackCloudType>
void Foam::mySprayParcel<ParcelType>::solveTABEq
(
    TrackCloudType& cloud,
    trackingData& td,
    const scalar dt
...
template<class ParcelType>
Foam::mySprayParcel<ParcelType>::mySprayParcel(const mySprayParcel<ParcelType>& p)
:
    ParcelType(p),
    d0_(p.d0_),
