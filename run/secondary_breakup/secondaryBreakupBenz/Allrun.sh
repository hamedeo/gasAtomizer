...
directories=$(find ./ -maxdepth 1 \( -name "secondaryBreakupBenz*" \) -not \( -path "./secondaryBreakupBenz_baseCase" -o -path "./secondaryBreakupBenz_Test" -o -path "./secondaryBreakupBenz_KH_Case2" \))
echo "$directories"
sleep 30
# Prompt the user to confirm shutdown
